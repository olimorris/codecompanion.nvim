...
local T = new_set({
  hooks = {
    pre_case = function()
      ...
      child.lua([[
        local SF = require("codecompanion.interactions.chat.tools.builtin.list_code_usages.symbol_finder")
      ...
      child.lua([[
        local LH = require("codecompanion.interactions.chat.tools.builtin.list_code_usages.lsp_handler")
