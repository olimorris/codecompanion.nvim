...
T["rejection reason is passed to LLM"] = function()
  child.lua([[
    -- Setup chat with run_command requiring approval
    local cfg = {
      interactions = {
        chat = {
          tools = {
    ...
    local test_chat, test_tools = h.setup_chat_buffer(cfg)
    _G.chat, _G.tools = test_chat, test_tools

    -- Stub approval_prompt to auto-select reject
