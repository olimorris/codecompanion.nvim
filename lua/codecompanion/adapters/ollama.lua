  ...
  schema = {
    model = {
      ...
      choices = {
        ...
        "dolphin-mistral-extract-patterns",
        "dolphin-mistral-improve-writing",
        "dolphin-mistral-chat",
        "dolphin-mistral-code-comments",
        "dolphin-mistral-code-generation",
        "dolphin-mistral-create-command",
        "dolphin-mistral-create-summary",
        "dolphin-mistral-creative-code-writing",
        "dolphin-mistral-cyber-grunt",
        "dolphin-mistral-fabric-ai",
        "dolphin-mistral-fabric-explain-code",
        "dolphin-mistral-multi-agent",
        "dolphin-mistral-agility-story",
        "dolphin-mistral-create-security-executive-summary",
        "dolphin-mistral",
        "dolphin-phi",
        "magicoder",
        "phi",
