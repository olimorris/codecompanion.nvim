...
- **No Side Effects:** Tool invocations should not alter your core tasks or the general conversation structure.]],
      ...
      slash_commands = {
        ["buffer"] = {
          ...
          opts = {
            contains_code = true,
            provider = default_providers.pick_provider,
          },
        },
        ["fetch"] = {
        ...
        ["help"] = {
          ...
          opts = {
            ...
            provider = default_providers.help_provider,
          },
        },
        ["now"] = {
...
5. Review and refine the workspace configuration together with the user]],
  ...
  display = {
    action_palette = {
      ...
      provider = default_providers.action_palette_provider,
      opts = {
    ...
    diff = {
      ...
      provider = default_providers.diff_provider
    },
    inline = {
