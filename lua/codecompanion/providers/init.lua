...
local configs = {
  ...
  -- Diffs
  inline_default = {
    module = "codecompanion.providers.diff.inline_default", -- Internal module path
    name = "inline_default",
...
local function diff_providers()
  local providers = { "default", "mini_diff" }
  return find_provider(providers, configs, "inline_default")
end
