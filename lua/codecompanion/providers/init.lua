...
local function action_palette_providers()
  local preferred_keys = { "telescope", "mini_pick", "snacks" }
...
local function help_providers()
  local preferred_keys = { "telescope", "snacks", "mini_pick", "fzf_lua" }
...
local function pick_providers()
  local preferred_keys = { "telescope", "snacks_conditional_picker", "mini_pick", "fzf_lua" }
  return find_provider(preferred_keys, all_provider_configs, "default")
end
