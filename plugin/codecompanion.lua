...
api.nvim_set_hl(0, "CodeCompanionChatPlanPending", { link = "Comment", default = true })
api.nvim_set_hl(0, "CodeCompanionChatPlanInProgress", { link = "DiagnosticInfo", default = true })
api.nvim_set_hl(0, "CodeCompanionChatPlanCompleted", { link = "Normal", default = true })
api.nvim_set_hl(0, "CodeCompanionChatPlanFailed", { link = "DiagnosticError", default = true })
