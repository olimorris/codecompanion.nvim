...
api.nvim_set_hl(0, "CodeCompanionChatToolInProgress", { link = "DiagnosticWarn", default = true })
api.nvim_set_hl(0, "CodeCompanionChatToolInProgressIcon", { link = "DiagnosticWarn", default = true })
