...
api.nvim_set_hl(0, "CodeCompanionChatInfoBanner", { link = "Visual", default = true })
api.nvim_set_hl(0, "CodeCompanionVirtualText", { link = "Comment", default = true })
api.nvim_set_hl(0, "CodeCompanionBannerKeymap", { link = "Title", default = true })
api.nvim_set_hl(0, "CodeCompanionNumber", { link = "Number", default = true })
