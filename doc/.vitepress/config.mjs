      ...
      sidebar: [
        ...
        { text: "Troubleshooting", link: "/troubleshooting" },
        {
          ...
          items: [
            ...
            { text: "Tips & Tricks", link: "/usage/introduction" },
          ],
        },
        {
          text: "Configuration",
          ...
          items: [
            ...
            { text: "Chat Buffer UI", link: "/configuration/ui" },
            { text: "Tools", link: "/configuration/tools" },
            {
              text: "Context Management",
              link: "/configuration/context-management",
            },
            { text: "Sessions", link: "/configuration/sessions" },
            { text: "Callbacks", link: "/configuration/callbacks" },
            { text: "Diff", link: "/configuration/diff" },
            { text: "Inline", link: "/configuration/inline" },
