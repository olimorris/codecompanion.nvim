...
System prompts, memory and file/buffer shares will be preserved but all user, assistant and tool messages will be removed. The summary is generated by prompting the same LLM to summarize the chat history into a concise format.
