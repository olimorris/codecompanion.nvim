...
* **chat:** unified attachment system with dynamic config ([anthropic-document](https://github.com/olimorris/codecompanion.nvim/tree/anthropic-document))
  - `/attachment` slash command now handles both images and documents
